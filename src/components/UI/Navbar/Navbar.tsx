    ...
    <div className="lg:sticky lg:top-0">
      <div className="drawer lg:drawer-open z-50">
        ...
        <div className="drawer-content flex flex-col items-start justify-start p-1">
          ...
          <label
            htmlFor="my-drawer-2"
            className="btn btn-sm fixed bg-black bg-opacity-50 text-white drawer-button lg:hidden rounded-md"
          >
            <FaBars /> Menu
          </label>
        </div>
        <div className="drawer-side">
          ...
          <div className="menu border-r-2 lg:bg-white bg-base-200 bg-opacity-80 text-base-content min-h-full w-80 p-4">
            ...
            <div className="flex flex-col gap-2 min-h-[calc(100vh-25vh)]">
              <Link href={"/"}>
                <h1 className="flex items-center gap-2 text-xl font-bold hover:bg-black p-2 rounded-md hover:bg-opacity-30 duration-300">
                  <FaHouse />
                  Home
                </h1>
              </Link>
              ...
              <div className="dropdown dropdown-hover">
                <div
                  tabIndex={0}
                  role="button"
                  className="flex items-center gap-2 text-xl font-bold hover:bg-black p-2 rounded-md hover:bg-opacity-30 duration-300"
                >
                  <FaFileContract />
                  Dashboard
                </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div>
                <button className="flex items-center gap-2 text-xl font-bold p-2 rounded-md bg-red-500 hover:bg-red-800 text-white duration-300 w-full btn">
                  Logout
                </button>
              </div>
            </div>
